<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-2xl text-gray-800">Edit Lost Item</h2>
    </x-slot>
            ...
            <div class="bg-white shadow-sm rounded-xl p-8 border border-blue-100">
                ...
                <div class="mb-8 pb-6 border-b border-blue-100">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800">Edit Lost Item Report</h3>
                            <p class="text-sm text-gray-600 mt-1">Update the details of your lost item</p>
                        </div>
                    </div>
                </div>

                <form action="{{ route('lost-items.update', $lostItem->id) }}" 
                      method="POST" 
                    ...
                    <div class="group">
                        ...
                        <textarea name="description" 
                                  ...
                                  class="w-full px-4 py-3 border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-blue-300 resize-none">{{ $lostItem->description }}</textarea>
                    </div>
                    ...
                    <div class="group" x-data="{ fileName: '', imagePreview: '' }">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                            {{ $lostItem->photo ? 'Change Photo (Optional)' : 'Photo (Optional)' }}
                        </label>
