        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm rounded-xl p-6 mb-6 border border-blue-100">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800">Lost Items Registry</h3>
                            <p class="text-sm text-gray-600 mt-1">Report your lost items and help others find them</p>
                        </div>
                    </div>
                    <a href="{{ route('lost-items.create') }}"
                        class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 hover:shadow-md transition-all duration-300 font-medium flex items-center justify-center space-x-2 whitespace-nowrap">
            ...
            <form method="GET" action="{{ route('lost-items.index') }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <!-- Lost Date -->
                    <div class="group">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Lost Date</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-gradient-to-r from-blue-50 to-blue-100 text-left">
                            ...
                            <th class="p-4 font-semibold text-gray-700">Lost Date</th>
                    ...
                    <tbody class="divide-y divide-blue-100">
                        @forelse ($items as $item)
                            <tr class="hover:bg-blue-50 transition-colors duration-200">
                                ...
                                <td class="p-4 text-gray-600">{{ $item->lost_date }}</td>
                            ...
                            <tr>
                                <td colspan="6" class="text-center py-12">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-gray-500 text-lg font-medium">No lost items found</p>
                                        <p class="text-gray-400 text-sm mt-1">Lost items will appear here once reported</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
            ...
            <div class="lg:hidden space-y-4">
                ...
                @empty
                    <div class="bg-white shadow-sm rounded-xl p-12 border border-blue-100 text-center">
                        ...
                        <p class="text-gray-500 text-lg font-medium">No lost items found</p>
                        <p class="text-gray-400 text-sm mt-2">Lost items will appear here once reported</p>
                    </div>
                @endforelse
            </div>
