            ...
            <div class="bg-white shadow-sm rounded-xl p-8 border border-blue-100">
                ...
                <div class="mb-8 pb-6 border-b border-blue-100">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800">Report a Found Item</h3>
                            <p class="text-sm text-gray-600 mt-1">Help reunite someone with their lost item</p>
                        </div>
                    </div>
                </div>

                <form action="{{ route('found-items.store') }}" 
                      method="POST" 
                    ...
                    <div class="flex items-center justify-end space-x-3 pt-6 border-t border-blue-100">
                        ...
                        <button type="submit"
                                class="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 hover:shadow-md transition-all duration-300 font-medium flex items-center space-x-2">
