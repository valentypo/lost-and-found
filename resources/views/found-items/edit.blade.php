<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-2xl text-gray-800">Edit Found Item</h2>
    </x-slot>
            ...
            <div class="bg-white shadow-sm rounded-xl p-8 border border-blue-100">
                ...
                <div class="mb-8 pb-6 border-b border-blue-100">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800">Edit Found Item Report</h3>
                            <p class="text-sm text-gray-600 mt-1">Update the details of the found item</p>
                        </div>
                    </div>
                </div>
                ...
                <form action="{{ route('found-items.update', $foundItem->id) }}" 
                    ...
                    <div class="group">
                        ...
                        <textarea name="description" 
                                  ...
                                  class="w-full px-4 py-3 border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-300 hover:border-blue-300 resize-none">{{ $foundItem->description }}</textarea>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="group">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                Location Found <span class="text-red-500">*</span>
                            </label>
                            <div class="relative">
                        ...
                        <div class="group">
                            <label class="block text-sm font-semibold text-gray-700 mb-2">
                                Found Date <span class="text-red-500">*</span>
                            </label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <svg class="w-5 h-5 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="group">
                        ...
                        <div class="border-2 border-blue-200 rounded-lg p-4 bg-blue-50">
                            <img src="{{ asset('storage/'.$foundItem->photo) }}" 
                                 ...
                                 class="max-h-64 mx-auto rounded-lg border-2 border-blue-300">
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="group" x-data="{ fileName: '', imagePreview: '' }">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">
                            {{ $foundItem->photo ? 'Change Photo (Optional)' : 'Photo (Optional)' }}
                        </label>
                    ...
                    <div class="group">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   name="contact_number" 
                                   value="{{ $foundItem->contact_number }}"
                                   required
